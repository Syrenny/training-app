...
export function CompletionButton({
  ...
  return (
    <button
      ...
      className={cn(
        "relative inline-flex h-9 w-24 shrink-0 items-center justify-center overflow-hidden rounded-full px-3 text-xs font-medium whitespace-nowrap transition-colors touch-none",
        completed
