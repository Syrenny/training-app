    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "program_payload",
                    models.JSONField(default=dict, verbose_name="Снапшот программы"),
                ),
                (
                    "started_at",
                    models.DateTimeField(
                        auto_now_add=True, verbose_name="Начало цикла"
                    ),
                ),
                (
                    "completed_at",
                    models.DateTimeField(
                        blank=True, null=True, verbose_name="Завершение цикла"
                    ),
                ),
                (
                    "completion_reason",
                ...
                (
                    "completion_feeling",
                    models.TextField(
                        blank=True, default="", verbose_name="Ощущения от программы"
                    ),
                ),
                (
                    "program",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "action",
                    models.CharField(
                        choices=[("DELETE", "Удалить"), ("REPLACE", "Заменить")],
                        max_length=10,
                ...
                (
                    "slot_key",
                    models.CharField(max_length=100, verbose_name="Ключ позиции"),
                ),
                (
                    "week_number",
                ...
                (
                    "reason",
                    models.TextField(
                        blank=True, default="", verbose_name="Причина адаптации"
                    ),
                ),
                (
                    "created_at",
